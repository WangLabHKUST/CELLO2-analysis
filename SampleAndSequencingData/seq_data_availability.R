...
dt = read.delim("seq_data_availability.txt",stringsAsFactors = F)
...
osnd = read.delim('glass_cell2022_oldsamplenewRNAseq.txt')
...
nsnd = read.delim('glass_cell2022_newSamplewithRNAseq.txt')
pl = read.delim('GLASS-DNAseq-samples-hmmissing.hmstatusdetermined.txt')
...
pdf(file = 'Fig1b_seq_data_heatmap.pdf', width = 8.5, height =3)
